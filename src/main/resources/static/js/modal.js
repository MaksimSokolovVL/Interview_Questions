...
function saveUpUser() {
    ...
    console.log(userId, firstName, lastName, email, password, active, roles)
...
function deleteUser() {
    ...
    const url = 'api/admin/users/' + _user_id
